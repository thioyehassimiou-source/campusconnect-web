...
import { ChevronLeft, ChevronRight, Plus, Search, Bell, Settings } from 'lucide-react'
...
const days = [
  { name: 'Lundi', date: 11 },
  { name: 'Mardi', date: 12, isToday: true },
  { name: 'Mercredi', date: 13 },
  { name: 'Jeudi', date: 14 },
  { name: 'Vendredi', date: 15 }
]
  ...
  return (
    <div className="max-w-[1400px] mx-auto animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between mb-10 gap-8">
        <div>
          <h2 className="text-4xl font-black text-primary tracking-tighter mb-1">Mars 2024</h2>
          <p className="text-on-surface-variant font-black uppercase tracking-[0.2em] text-xs opacity-70">
            Semaine 12 — Semestre 2
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-6">
          <div className="flex items-center gap-1 bg-surface-container-low p-1.5 rounded-2xl border border-outline-variant/10 shadow-inner">
            <button className="px-6 py-2.5 text-[11px] font-black uppercase tracking-widest rounded-xl text-on-surface-variant hover:bg-surface-container-high transition-all">Jour</button>
            <button className="px-6 py-2.5 text-[11px] font-black uppercase tracking-widest rounded-xl bg-surface-container-lowest shadow-md text-primary ring-1 ring-black/5">Semaine</button>
            <button className="px-6 py-2.5 text-[11px] font-black uppercase tracking-widest rounded-xl text-on-surface-variant hover:bg-surface-container-high transition-all">Mois</button>
          </div>
